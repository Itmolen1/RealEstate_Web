<?php
	...
	class User_api_model extends CI_Model 
	{
		...
		public function add_user_address($val)
		{
			$data=array(
		        'user_id'=>$val['user_id'],
		        'user_address_type'=>$val['user_address_type'],
		...
		public function update_user_address_by_id($data)
		{
			...
			$this->db->set('user_address_type',$data['user_address_type']);
		...
		function get_user_address_list($data)
		{
			...
			$sql="SELECT user_address_id,user_address_type,user_address,user_latitude,user_longitude,person_name,person_mobile FROM tbl_user_address  WHERE isDeleted = 0 AND user_id = ".$data['user_id']." ORDER BY user_address_id DESC ";
			$query = $this->db->query($sql);				
			$rows=$query->result_array();
			return $rows;
		}
